...
public class RecurringSession extends Session {
     ...
     * @param sessionDate1 a sessionDate value
     * @param sessionDate2 another SessionDate value
     * @param interval the interval of recurrence
     * @return true if the session and other session is consistent in terms of Date, given 0 or more recurrence.
     */
